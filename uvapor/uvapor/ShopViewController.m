...
- (void)startLoad
{
//    NSString *url_str = [NSString stringWithFormat:url_string@"http://www.stw-ecig.com"];
    
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:self.url_string]];
    //超时时间
