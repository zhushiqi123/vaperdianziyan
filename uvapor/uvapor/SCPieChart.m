...
-(id)initWithFrame:(CGRect)frame items:(NSArray *)items
{
    ...
    if(self)
    {
        ...
        _outerCircleRadius  = CGRectGetWidth(self.bounds) / 4;
        _innerCircleRadius  = CGRectGetWidth(self.bounds) / 12;
...
- (UILabel *)descriptionLabelForItemAtIndex:(NSUInteger)index
{
    ...
    CGPoint center = CGPointMake(_outerCircleRadius * 2 + distance * sin(rad),
...
//    NSLog(@"x - %f,y - %f,weight - %f,height - %f,text - %@",descriptionLabel.frame.origin.x, descriptionLabel.frame.origin.y,
//          descriptionLabel.frame.size.width, labelSize.height,descriptionLabel.text);
