...
//    UIAlertView *av = [[UIAlertView alloc] initWithTitle:status message:nil delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil];
    UIAlertView *av = [[UIAlertView alloc] initWithTitle:status message:nil delegate:nil cancelButtonTitle:[InternationalControl return_string:@"window_confirm"]otherButtonTitles:nil];
    [av show];
}
