...
static const double successPoint4ScaleX = 90.00/250.00;
static const double successPoint4ScaleY = 51.00/250.00;

static const double successPoint5ScaleX = 125.00/250.00;
static const double successPoint5ScaleY = 90.00/250.00;

static const double successPoint6ScaleX = 160.00/250.00;
static const double successPoint6ScaleY = 126.00/250.00;

static const double successPoint7ScaleX = 160.00/250.00;
static const double successPoint7ScaleY = 51.00/250.00;
...
//竖线02
- (UIBezierPath *)verticalLineStartPath02{
    _verticalLineStartPath02 = [UIBezierPath bezierPath];
    [_verticalLineStartPath02 moveToPoint:CGPointMake(halfSquare,arrowPointY+kSpacing)];
    [_verticalLineStartPath02 addLineToPoint:CGPointMake(halfSquare,arrowPointY * 2+kSpacing)];
    return _verticalLineStartPath02;
}
...
- (UIBezierPath *)errorPath{
    ...
    CGFloat successPoint4X = SW*successPoint4ScaleX;
    CGFloat successPoint4Y = SW*successPoint4ScaleY;
    
    CGFloat successPoint5X = SW*successPoint5ScaleX;
    CGFloat successPoint5Y = SW*successPoint5ScaleY;
    
    CGFloat successPoint6X = SW*successPoint6ScaleX;
    CGFloat successPoint6Y = SW*successPoint6ScaleY;
    
    CGFloat successPoint7X = SW*successPoint7ScaleX;
    CGFloat successPoint7Y = SW*successPoint7ScaleY;

    [_errorPath moveToPoint:CGPointMake(successPoint1X, successPoint1Y)];
    [_errorPath addLineToPoint:CGPointMake(successPoint5X, successPoint5Y)];
    [_errorPath addLineToPoint:CGPointMake(successPoint7X, successPoint7Y)];
    [_errorPath addLineToPoint:CGPointMake(successPoint5X, successPoint5Y)];
    [_errorPath addLineToPoint:CGPointMake(successPoint4X, successPoint4Y)];
    [_errorPath addLineToPoint:CGPointMake(successPoint5X, successPoint5Y)];
    [_errorPath addLineToPoint:CGPointMake(successPoint6X, successPoint6Y)];
